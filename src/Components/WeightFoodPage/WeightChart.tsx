...
export const WeightChart: React.FC<WeightChartProps> = ({
   ...
   const getLocale = () => {
      switch (getDateLocale()) {
         case "de" as unknown as Locale:
            return deLocale;
         case "uk" as unknown as Locale:
            return ukLocale;
         case "ru" as unknown as Locale:
            return ruLocale;
         default:
            return undefined;
      }
   ...
   useEffect(() => {
      ...
      if (selectedDate >= startDate && selectedDate <= endDate) {
         ...
         const currentMorningW = currentMorningWeight
            ? parseFloat(currentMorningWeight)
            : null;
         const currentEveningW = currentEveningWeight
            ? parseFloat(currentEveningWeight)
            : null;
